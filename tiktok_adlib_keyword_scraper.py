...
A script to collect TikTok Ad Library ad IDs for a given keyword, country, and time range
using the TikTok Commercial Content API.
Requirements:
- Python 3.8+
- requests
- python-dotenv
...
3. Run:
    python tiktok_adlib_keyword_scraper.py keyword1 keyword2 ...
"""
